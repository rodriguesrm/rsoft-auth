...
namespace RSoft.Framework.Web.Api
{
    ...
    public abstract class ApiBaseController : ControllerBase, IDisposable
    {
        ...
        /// </summary>
        /// <param name="notificacoes">Notifications list generated by the domain layer</param>
        protected IEnumerable<GenericNotificationResponse> GetNotificationsErrors(IReadOnlyCollection<Notification> notificacoes)
        {

            IList<GenericNotificationResponse> result = new List<GenericNotificationResponse>();

            foreach (Notification n in notificacoes)
            {
